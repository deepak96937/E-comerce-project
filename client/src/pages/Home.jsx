    ...
    <div>
      ...
      <div className=" flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto ">
        ...
        <div className=" text-gray-400 text-xs sm:text-sm">
          Deepak Estate is the best place to find your next perfect place to live.
          <br />
          We have a wide reange of properties for you to choose from.
        </div>
      ...
      {/* Listing results for offer,s ale and rent */}
